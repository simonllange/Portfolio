      ...
      <Container maxW="container.md">
        ...
        <Section delay={0.1}>
          ...
          <Paragraph>
            ...
            funktionalitet. Jeg er baseret i Kolding og har en rigtig stor
            passion for, at udvikle mig selv og komme frem til de bedste
            digitale løsninger, samt lærer det, som er den nye trend. Elsker at
        ...
        <Section delay={0.1}>
          ...
          <Paragraph>
            Webudvikling er en verden med mange værktøjer, og jeg forsøger så
            vidt muligt at lære de ting som jeg synes virker mest oplagt og
            giver det bedste slutprodukt. Jeg har nemt ved at lærer nye ting,
            men som hver anden udvikler, så er det selvfølgelig svært at kunne
            det hele. Jeg drømmer om, at kunne kalde mig selv full-stack en dag,
            men på nuværende tidspunkt prøver jeg at blive den bedste front-end
            udvikler jeg kan være.
          </Paragraph>
        </Section>
        <Box mb={10} />
        <Section>
